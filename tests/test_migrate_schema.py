...
class ApprovalSchemaMigrationTests(unittest.TestCase):
    ...
    def test_manual_tables_use_postgres_identity_columns(self):
        self.assertEqual(
            migrate_schema._identity_primary_key(FakeConnection("postgresql")),
            "INTEGER GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY",
        )
        self.assertEqual(
            migrate_schema._identity_primary_key(FakeConnection("sqlite")),
            "INTEGER PRIMARY KEY",
        )
