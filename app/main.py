...
from app.routers import about, audit, auth, dashboard, documents, imports, movements, notifications, procurement, products, profiles, reports, requisitions, users
...
for router in [auth.router, dashboard.router, products.router, movements.router, requisitions.router, procurement.router, reports.router, users.router, profiles.router, imports.router, audit.router, notifications.router, documents.router, about.router]:
