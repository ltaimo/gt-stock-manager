...
from app.routers import about, audit, auth, dashboard, documents, hse, imports, internal_ops, movements, notifications, preferences, procurement, products, profiles, reports, requisitions, settings as settings_router, users
...
for router in [auth.router, dashboard.router, products.router, movements.router, requisitions.router, procurement.router, hse.router, internal_ops.router, settings_router.router, preferences.router, reports.router, users.router, profiles.router, imports.router, audit.router, notifications.router, documents.router, about.router]:
