...
class RequisitionItem(Base):
    ...
    estimated_unit_price: Mapped[float] = mapped_column(Numeric(14, 2), default=0)
    quantity_issued: Mapped[float] = mapped_column(Numeric(12, 2), default=0)
    quantity_received: Mapped[float] = mapped_column(Numeric(12, 2), default=0)
...
class InternalOperationRecord(Base):
    ...
    operation_type: Mapped[str | None] = mapped_column(String(40), index=True)
    ...
    odometer_reading: Mapped[float | None] = mapped_column(Numeric(14, 2))
    meter_reading: Mapped[float | None] = mapped_column(Numeric(14, 2))
